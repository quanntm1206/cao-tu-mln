...
export const QUICK_EVENTS: QuickEvent[] = [
    ...
    choices: [
      {
        ...
        resultText: 'Bạn tăng tỷ lệ tái đầu tư — điều kiện mở rộng quy mô tư bản (mô phỏng giản lược).',
  ...
  },
  {
    ...
    choices: [
      {
        id: 'exhibit',
        label: 'Tham gia triển lãm — thực hiện giá trị hàng hóa',
  ...
  // ── Pha 3: Tư bản tài chính (vòng 9-12) ───────────────────────────────────
  {
    ...
    teachingPoint: 'Khi tỷ suất lợi tức Z′ tăng, lợi tức Z phải trả trên cùng TBCV tăng và phần m còn lại sau phân phối có thể giảm.',
    choices: [
      {
        id: 'borrow-now',
        label: 'Vay thêm 200 triệu trước khi lãi tăng',
        resultText: 'Bạn huy động vốn vay với lãi suất hiện tại trước khi điều chỉnh.',
        teachingPoint: 'Vay trước khi Z′ tăng là cách giảm lợi tức Z phải trả trên cùng lượng tư bản vay.',
    ...
    choices: [
      {
        ...
        resultText: 'Bạn tiếp cận nguồn vốn rẻ, giảm chi phí lợi tức Z.',
        teachingPoint: 'Tỷ suất lợi tức Z′ ưu đãi thấp hơn thị trường phản ánh can thiệp nhà nước vào phân phối lợi tức Z.',
  ...
  },
  {
    ...
    choices: [
      ...
      },
      {
        ...
        teachingPoint: 'Tiền không chuyển hóa thành tư bản cho vay thì không thu được lợi tức Z; đây là lãng phí tư bản dưới góc nhìn kinh tế tư bản.',
        effect: {},
      },
    ],
  },
  {
    ...
    teachingPoint: 'Tỷ suất lợi tức Z′ biến động theo chu kỳ kinh tế; Z′ thấp làm giảm lợi tức Z phải trả trên cùng TBCV.',
    choices: [
      {
        id: 'expand-loan',
        label: 'Vay thêm 300 triệu — tăng thanh khoản',
        resultText: 'Bạn tận dụng lãi suất thấp để tăng vốn khả dụng; khoản vay không tự tạo m.',
        teachingPoint: 'Khi Z′ giảm, người vay trả ít lợi tức Z hơn trên cùng TBCV; phần m còn lại sau phân phối có thể tăng.',
      ...
      },
      {
        ...
        teachingPoint: 'Thận trọng đòn bẩy tài chính giúp bảo vệ khỏi rủi ro khi Z′ tăng trở lại.',
        effect: {},
      },
    ],
  },
    ...
    choices: [
      {
        ...
        resultText: 'Bạn giảm dư nợ để cắt giảm chi phí lợi tức Z trong bối cảnh tín dụng siết chặt.',
        teachingPoint: 'Giảm nợ khi Z′ cao bảo vệ phần m/lợi nhuận giữ lại khỏi bị ăn mòn bởi lợi tức Z.',
        effect: { debtDelta: -200 * M, cashDelta: -200 * M },
      },
      {
        id: 'maintain-debt',
  ...
  },
  {
    ...
    teachingPoint: 'Tỷ suất lợi tức Z′ cao hơn phản ánh rủi ro lớn hơn trên thị trường tư bản cho vay.',
    choices: [
      {
        id: 'lend-high-yield',
        ...
        teachingPoint: 'Z′ cao bù đắp rủi ro; lợi tức Z thu được phản ánh phần m được phân phối cho tư bản cho vay.',
    ...
    choices: [
      {
        ...
        teachingPoint: 'Bán kịp thời khi bong bóng vỡ cho thấy giá đất có thể tách xa cơ sở địa tô do kỳ vọng giá — không phải m mới do lao động.',
        effect: { cashDelta: 80 * M },
      },
      {
        id: 'hold-wait',
    ...
    choices: [
      {
        ...
        teachingPoint: 'Tăng giá tài sản phản ánh địa tô được vốn hóa thêm khi Z′ giảm (P = R/Z′); không tạo m mới.',
      ...
      },
      {
        ...
        teachingPoint: 'Thị trường BĐS biến động khi Z′ thay đổi, phản ánh tính không ổn định của vốn hóa địa tô.',
        effect: {},
      },
    ],
  },
