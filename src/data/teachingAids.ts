...
export const FINAL_CHECKLIST: string[] = [
  ...
  'Phân biệt p, lợi nhuận thương nghiệp, lợi tức Z, tỷ suất lợi tức Z′, địa tô R và mối quan hệ với m.',
  'Sử dụng P = R/Z′ để giải thích vì sao giá đất tăng khi Z′ giảm (địa tô tư bản hóa).',
