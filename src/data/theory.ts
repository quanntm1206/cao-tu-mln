...
export const THEORY_SECTIONS: TheorySection[] = [
  ...
  },
  {
    ...
    symbolGuide: 'R = địa tô; Z′ = tỷ suất lợi tức; P = R/Z′ (địa tô tư bản hóa).',
...
export const THEORY_LESSONS: TheoryLesson[] = [
  {
    ...
    formula: "T − H − T′",
    symbolGuide: "T = tiền ban đầu; H = hàng hóa sản xuất; T′ = tiền thu về — biểu hiện m đã tạo trong sản xuất.",
  ...
  },
  {
    ...
    explanation: 'Lợi tức Z là giá cả của tư bản cho vay — phần m/lợi nhuận phân phối cho chủ tư bản cho vay. Z′ = Z/TBCV. Tín dụng tăng thanh khoản nhưng không tự tạo m.',
    marxSource: SOURCE,
  },
  {
    round: 8,
  ...
  },
  {
    ...
    explanation: 'P = R/Z′ (địa tô tư bản hóa). Khi Z′ giảm, P tăng dù R không đổi. Đất không có giá trị theo nghĩa sản phẩm lao động nhưng có giá cả do quyền sở hữu thu địa tô.',
    marxSource: SOURCE,
  },
  {
    round: 12,
