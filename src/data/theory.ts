...
export const THEORY_SECTIONS: TheorySection[] = [
  ...
  },
  {
    ...
    pages: 'tr. 73-74',
    formula: 'm = p_CN + p_TN (p_TN là phần m nhượng cho thương nhân)',
    symbolGuide: 'p_TN = lợi nhuận thương nghiệp, là phần giá trị thặng dư nhà sản xuất nhượng cho thương nhân để lưu thông hàng hóa.',
    ...
    keyPoints: [
      'p_TN không phát sinh từ lưu thông mà là phân phối từ m',
  ...
  },
  {
    ...
    pages: 'tr. 74-76',
    formula: 'Z = tư bản cho vay x lãi suất i',
    symbolGuide: 'Z = lãi tức (interest), i = lãi suất. Tư bản cho vay nhận Z mà không tham gia sản xuất.',
    explanation: 'Lãi tức là phần lợi nhuận mà nhà tư bản sản xuất nhượng cho chủ sở hữu tư bản cho vay. Lãi suất i = Z/tư bản cho vay, phản ánh giá cả của tư bản. Lãi suất có xu hướng biến động theo chu kỳ kinh tế và chính sách tiền tệ.',
    keyPoints: [
      "Tư bản cho vay: T - T' (không qua H, không sản xuất)",
      'Lãi suất = phần m chuyển cho chủ nợ',
      "Giới hạn: 0 < i < p' (cách dưới là 0, cách trên là toàn bộ lợi nhuận)",
  ...
  },
  {
    ...
    pages: 'tr. 76-78',
    formula: 'Giá đất = R / i',
    symbolGuide: 'R = địa tô (land rent), i = lãi suất. Giá đất = R vốn hóa theo lãi suất.',
...
export const THEORY_LESSONS: TheoryLesson[] = [
  ...
  },
  {
    ...
    formula: 'm = p_CN + p_TN',
    symbolGuide: 'p_TN = phần m nhượng cho thương nhân để lưu thông hàng hóa.',
  ...
  },
  {
    ...
    explanation: 'Thương nhân rút ngắn thời gian lưu thông, tăng n vòng quay. Nhưng p_TN vẫn là phần m từ sản xuất - lưu thông không tạo thêm giá trị mới.',
    marxSource: SOURCE,
  },
  {
    round: 7,
    ...
    symbolGuide: "Z = lãi tức; i = lãi suất. Tư bản cho vay vận động T - T' mà không qua sản xuất.",
  ...
  {
    round: 13,
    title: 'Phân chia GTTT: m = p + p_TN + Z + R',
    concept: 'surplus_distribution',
    formula: 'm = p + p_TN + Z + R',
    symbolGuide: 'p = lợi nhuận CN; p_TN = lợi nhuận TN; Z = lãi tức; R = địa tô.',
    explanation: 'Toàn bộ giá trị thặng dư m được phân chia giữa 4 hình thức: lợi nhuận sản xuất p (nhà tư bản CN giữ), lợi nhuận thương nghiệp p_TN (thương nhân), lãi tức Z (ngân hàng/cho vay), địa tô R (chủ sở hữu đất).',
    marxSource: SOURCE,
  },
  {
    round: 14,
  ...
  },
  {
    ...
    symbolGuide: 'Toàn bộ GTTT phát sinh trong sản xuất, được phân phối qua 4 kênh. M-pool = vốn ban đầu + phần m giữ lại.',
...
export const TOOLTIP_FORMULAS: Record<string, string> = {
  ...
  z: 'Z = tư bản cho vay x lãi suất i',
  r: 'Giá đất = R / i - vốn hóa địa tô',
  m_pool: 'M-pool = vốn ban đầu + m giữ lại',
  industrial_profit: 'p = m của nhà tư bản CN giữ lại',
  merchant_profit: 'p_TN = phần m nhượng cho thương nhân',
