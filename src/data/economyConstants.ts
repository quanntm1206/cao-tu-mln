...
/**
 * Moi nganh co cau tao huu co c/v khac nhau (organicComposition).
 */
export const SECTOR_PROFILES = [
  {
    ...
    archetype: 'Tham dung may moc (c cao, v thap)',
  ...
  },
  {
    ...
    surplusValueRate: 1.0,
    archetype: 'Can bang von-lao dong',
    examples: 'Vinatex, Viet Tien',
  },
  {
    id: 'da',
    label: 'Da giay',
    ...
    surplusValueRate: 1.0,
    archetype: 'Tham dung lao dong (v cao, c thap)',
    examples: "Biti's, gia cong Nike",
  },
] as const
