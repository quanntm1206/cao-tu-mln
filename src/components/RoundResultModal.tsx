...
export default function RoundResultModal() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center modal-backdrop bg-black/70">
      <div className="theory-card rounded-2xl p-6 w-full max-w-2xl mx-4 shadow-2xl max-h-[90vh] overflow-y-auto">
        ...
        <button onClick={dismissLesson} className="w-full mt-5 py-3 rounded-xl font-bold text-stone-50 transition-all btn-primary">
          {continueLabel}
        </button>
      </div>
    </div>
